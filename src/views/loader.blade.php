...
<head>
  ...
  <title>Fish Bowl Loader - Tailwind Version</title>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
  <div class="flex flex-col items-center">
    ...
    <section class="loader">
      ...
      <svg height="200px" width="200px" version="1.1" class="fish" xmlns="http://www.w3.org/2000/svg"
        ...
        <g>
          ...
          <g>
            <path style="opacity: 0.23; fill: #315591; enable-background: new"
            ...
            <circle style="fill: #315591" cx="413.916" cy="255.823" r="10.653"></circle>
          </g>
          <path style="fill: #52a2e7"
